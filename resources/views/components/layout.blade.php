...
<body class="bg-gray-100 font-geist h-screen">
    <header class="bg-white shadow flex items-center justify-between p-4 relative z-50">
        ...
        <div>
            <nav class="hidden md:flex space-x-4 items-center">
                ...
                <x-nav-link>Produtos</x-nav-link>
                <x-nav-link><i class="fa-solid fa-cart-shopping"></i> Carrinho</x-nav-link>
        ...
        <div id="mobile-menu" class="hidden md:hidden bg-white shadow-lg absolute top-[100%] left-0 w-full z-40">
            <nav class="flex flex-col items-center space-y-2 p-4">
                <x-nav-link>Home</x-nav-link>
                <x-nav-link>Produtos</x-nav-link>
                <x-nav-link>Carrinho</x-nav-link>
                <x-nav-link type="button">Login</x-nav-link>
            </nav>
        </div>
